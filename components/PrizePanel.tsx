    ...
    >
      ...
      {imageDataUrl && !disabled && (
        <button
          ...
          className="mb-3 text-sm text-[var(--bni-red-dark)] underline"
        >
          移除圖片
        </button>
      )}
      ...
      <input
        ...
        className="mt-1 rounded-lg border border-gray-300 px-3 py-2 text-base focus:border-[var(--bni-red)] focus:outline-none focus:ring-2 focus:ring-[var(--bni-red)]/30 disabled:opacity-60"
      />
